            ...
            <form class="form-horizontal" action="{{ route('generalsettings.color.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="color-radio col-sm-3">
                            <label>
                                <input type="radio" name="frontend_color" class="color-control-input" value="8" @if(\App\GeneralSetting::first()->frontend_color == '8') checked @endif>
                                <span class="color-control-box" style="background:dimgray;"></span>
                            </label>
                        </div>
                    </div>
                </div>
