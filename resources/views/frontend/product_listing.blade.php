                                    ...
                                    <ul class="inline-links">
                                        ...
                                        @foreach ($brands as $key => $id)
                                            @if (\App\Brand::find($id) != null)
                                                <li><a href="{{ route('products.brand', \App\Brand::find($id)->slug) }}"><img src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset(\App\Brand::find($id)->logo) }}" alt="{{ \App\Brand::find($id)->name }}" class="img-fluid lazyload"></a></li>
                                            @endif
                                        @endforeach
                                    </ul>
                                </div>
                                        ...
                                        <div class="product-box-2 bg-white alt-box my-md-2">
                                            <div class="position-relative overflow-hidden">
                                                ...
                                                @if($product->type == "affiliate")
                                                    <a href="{{ $product->affiliate_link }}" target="_blank" class="d-block product-image h-100 text-center" tabindex="0">
