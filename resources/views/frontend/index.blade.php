        ...
        <div class="container">
            <div class="row no-gutters position-relative">
                ...
                @php
                    ...
                    $video_mode = \App\BusinessSetting::where('type', 'video_mode')->first()->value;
                $videos = \App\Banner::where('position',5)->where('published',1)->get();
                @endphp
                            ...
                            <div class="rvs-container">
                                <div class="rvs-item-container">
                                    ...
                                    <div class="rvs-item-stage">
                                        ...
                                        <div class="rvs-item" style="background-image: url({{$video->photo_link}})">
                                            <p class="rvs-item-text">{{$video->title}}</p>
                                            <a href="{{$video->video_link}}" class="rvs-play-video"></a>
                                        </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="rvs-nav-container">
                                    ...
                                    <div class="rvs-nav-stage">
                                        ...
                                        <a class="rvs-nav-item">
                                            <span class="rvs-nav-item-thumb" style="background-image: url({{$video->photo_link}})"></span>
                    ...
                    <div class="flash-deal-box bg-white h-100">
                        ...
                        <div class="flash-content c-scrollbar c-height">
                            @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->get() as $key => $product)
                                @if ($product != null)
                                    <a href="@if($product->type == "affiliate"){{ $product->affiliate_link }} @else {{ route('product', $product->slug) }} @endif" class="d-block flash-deal-item" @if($product->type == "affiliate") target="_blank" @endif>
                            ...
                            <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                <div class="card-body p-0">
                                    <div class="card-image">
                                        <a href="@if($product->type == "affiliate"){{ $product->affiliate_link }} @else {{ route('product', $product->slug) }} @endif" class="d-block" @if($product->type == "affiliate") target="_blank" @endif>
                                    ...
                                    <div class="p-md-3 p-2">
                                        ...
                                        <h2 class="product-title p-0">
                                            <a href="@if($product->type == "affiliate"){{ $product->affiliate_link }} @else {{ route('product', $product->slug) }} @endif"  @if($product->type == "affiliate") target="_blank" @endif class=" text-truncate">{{ __($product->name) }}</a>
                                        </h2>
                                    </div>
                                </div>
                            </div>
