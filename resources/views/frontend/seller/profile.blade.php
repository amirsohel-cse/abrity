                        ...
                        <form class="" action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__(' Trade License Photo')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="file" name="trade_license" id="file-34" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" accept="image/pdf*" />
                                            <label for="file-34" class="mw-100 mb-3">
                                                <span></span>
                                                <strong>
                                                    <i class="fa fa-upload"></i>
                                                    {{__('Choose image')}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="file" name="nid_front" id="file-35" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" accept="image/pdf*" />
                                            <label for="file-35" class="mw-100 mb-3">
                                                <span></span>
                                                <strong>
                                                    <i class="fa fa-upload"></i>
                                                    {{__('Choose image')}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="file" name="nid_back" id="file-36" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" accept="image/pdf*" />
                                            <label for="file-36" class="mw-100 mb-3">
                                                <span></span>
                                                <strong>
                                                    <i class="fa fa-upload"></i>
                                                    {{__('Choose image')}}
