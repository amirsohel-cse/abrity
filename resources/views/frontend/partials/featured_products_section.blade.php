                    ...
                    <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                        <div class="card-body p-0">
                            ...
                            <div class="card-image">
                                <a href="@if($product->type == "affiliate"){{ $product->affiliate_link }} @else {{ route('product', $product->slug) }} @endif" @if($product->type == "affiliate") target="_blank" @endif class="d-block">
                            ...
                            <div class="p-md-3 p-2">
                                ...
                                <h2 class="product-title p-0 text-truncate-2">
                                    <a href="@if($product->type == "affiliate"){{ $product->affiliate_link }} @else {{ route('product', $product->slug) }} @endif" @if($product->type == "affiliate") target="_blank" @endif >{{ __($product->name) }}</a>
                                </h2>
                            </div>
                        </div>
                    </div>
