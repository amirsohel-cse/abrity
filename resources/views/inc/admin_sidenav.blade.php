                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['importExportView'])}}">
                                        <a class="nav-link" href="{{route('importExportView')}}">{{__('Import Products')}}</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['contact_us.index','contact_us.show'])}}">
                                    <a class="nav-link" href="{{route('contact_us.index')}}">{{__('Contact Us')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['notification.index', 'notification.edit'])}}">
                                    <a class="nav-link" href="{{ route('notification.index') }}">{{__('Notification List')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['notification.create'])}}">
                                    <a class="nav-link" href="{{route('notification.create')}}">{{__('Add Notification')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('15', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                ...
                                <ul class="collapse">
                                    <li class="">
                                        <a class="nav-link" href="{{ route('index.driver') }}">{{__('All driver')}}</a>
                                    </li>
                                    <li class="">
                                        <a class="nav-link" href="{{ route('add.driver') }}">{{__('Add driver')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        @if(Auth::user()->user_type == 'admin')
                        @elseif(in_array('16', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                <a href="#">
                                    <i class="fa fa-car"></i>
                                ...
                                <ul class="collapse">
                                    <li class="">
                                        <a class="nav-link" href="{{ route('driver.orders') }}">{{__('Orders')}}</a>
                                    </li>
                                </ul>
                            </li>
