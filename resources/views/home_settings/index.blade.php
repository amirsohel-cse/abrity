...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-6" aria-expanded="true">{{ __('Video slider') }}</a>
            </li>
            <li class="">
        ...
        <div class="tab-content">
            ...
            <div id="demo-lft-tab-6" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_banner_5()" class="btn btn-rounded btn-info pull-right">{{__('Add Video Slider')}}</a>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            ...
                            @foreach(\App\Banner::where('position', 5)->get() as $key => $banner)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{ $banner->title }}</td>
                                    <td><img loading="lazy"  class="img-md" src="{{ $banner->photo_link}}" alt="Thumb Image"></td>
