				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <select class="form-control demo-select2-placeholder" name="type"  required>
                                        <option @if($product->type == "general") selected @endif  value="general">General</option>
                                        <option @if($product->type == "affiliate") selected @endif value="affiliate">Affiliate</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-lg-2 control-label">{{__('Affiliate Link')}}</label>
                                <div class="col-lg-7">
                                    <input type="text" value="{{$product->affiliate_link}}" class="form-control" name="affiliate_link" placeholder="https://www.aliexpress.com" >
                                </div>
                            </div>
