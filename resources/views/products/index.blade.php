                ...
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td><label class="switch">
                                <input onchange="update_affiliate(this)" value="{{ $product->id }}" type="checkbox" <?php if($product->type == "affiliate") echo "checked";?> >
                            ...
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    @if ($type == 'Seller')
                                        ...
                                        <li><a href="{{route('products.review', encrypt($product->id))}}">{{__('Review')}}</a></li>
                                    @else
...
@section('script')
    <script type="text/javascript">
        ...
        function update_affiliate(el){
            ...
            $.post('{{ route('products.affiliate') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    showAlert('success', 'Affiliate products updated successfully');
                }
                else{
                    showAlert('danger', 'Something went wrong');
                }
