...
Route::get('/seller/registration', 'HomeController@registration')->name('seller.registration');
...
Route::post('/  ', 'HomeController@get_pick_ip_points')->name('shipping_info.get_pick_ip_points');
...
Route::post('/contact_us/save', 'HomeController@contact_us_store')->name('contact_us.save');
...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::post('/products/affiliate', 'ProductController@updateAffiliate')->name('products.affiliate');
