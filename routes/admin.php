...
//Route::get('/dashboard', 'HomeController@admin_dashboard')->name('dashboard')->middleware(['auth', 'admin']);
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    //notifications
    Route::resource('notification', 'NotificationResource');
    Route::get('/notification/destroy/{id}', 'NotificationResource@destroy')->name('notification.destroy');
    ...
    Route::get('/products/review/{id}','ProductController@review')->name('products.review');
    Route::post('/products/review/update/{id}','ProductController@review_update')->name('products.review.update');
    ...
    Route::get('sellers/documents/{id}','SellerController@documents')->name('sellers.documents');
    ...
    //driver routes
    Route::get('all/driver','DriverController@index')->name('index.driver');
    Route::get('edit/driver/{id}','DriverController@edit')->name('edit.driver');
    Route::post('update/driver/{id}','DriverController@update')->name('update.driver');
    Route::get('add/driver','DriverController@create')->name('add.driver');
    Route::post('add/driver','DriverController@store')->name('store.driver');
    Route::get('/destroy/driver/{id}', 'DriverController@destroy')->name('destroy.driver');

    //assign driver for order
    Route::get('/order/driver/{id}', 'OrderController@driver')->name('order.driver');
    Route::post('/driver/details', 'DriverController@show')->name('driver.details');
    Route::post('/driver/insert', 'DriverController@insert')->name('driver.insert');
    Route::get('driver/orders', 'DriverController@driver_orders')->name('driver.orders');
    ...
    Route::get('importExportView', 'ImportController@importExportView')->name('importExportView');
